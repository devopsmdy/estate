...
<form class="row" method="POST" action="/estate/search">
	...
	<div class="form-group border rounded p-3 col-sm-4">
		...
		<div class="form-check">
			<input class="form-check-input" type="checkbox" value="{{$township->id}}" id="township{{$township->id}}" name="township[]">
	...
	<div class="form-group border rounded p-3 col-sm-4">
		...
		<div class="form-group">
			...
			<input type="number" class="form-control mb-1" id="min_price" placeholder="Minimum Price" name="min_price" required="" value="0">
			<label for="max_price">To</label>
			<input type="number" class="form-control" id="max_price" placeholder="Maximum Price" name="max_price" required="" value="999999999999999999999">
		</div>
		<hr />
		<h4>Status</h4>
		<div class="form-group">
